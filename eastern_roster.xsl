...
/* Tables  */
    ...
    tr.TorontoFWD          {color:#010101;background-color:#00205B;text-shadow: 0 0 7px #FFFFFF;}
    tr.TorontoDEF          {color:#FFFFFF;background-color:#00205B;text-shadow: 0 0 7px #010101;}
    tr.TorontoGLT          {color:#A2AAAD;background-color:#00205B;text-shadow: 0 0 7px #FFFFFF;}
    tr.TorontoFWD          td {color:#010101;background-color:#00205B;text-shadow: 0 0 7px #FFFFFF;}
    tr.TorontoDEF          td {color:#FFFFFF;background-color:#00205B;text-shadow: 0 0 7px #010101;}
    tr.TorontoGLT          td {color:#A2AAAD;background-color:#00205B;text-shadow: 0 0 7px #FFFFFF;}
